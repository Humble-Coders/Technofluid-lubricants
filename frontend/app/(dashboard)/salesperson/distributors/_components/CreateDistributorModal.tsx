// File: frontend/app/(dashboard)/salesperson/distributors/_components/CreateDistributorModal.tsx
"use client";
...
type CreateDistributorModalProps = {
  onClose: () => void;
  onSubmit: (distributor: CreateDistributorFormInput) => Promise<void>;
};
