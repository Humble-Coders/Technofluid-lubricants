...
type EditSupervisorFormInput = {
  name: string;
  phone: string;
};

type EditSupervisorModalProps = {
  open: boolean;
  initial: EditSupervisorFormInput & { id: string };
  onClose: () => void;
  onSave: (id: string, fields: EditSupervisorFormInput) => Promise<void>;
};
